...
- **Spawn workers**: `./tools/workers spawn <name> "<task>" --dir /Users/pankajgarkoti/Desktop/code/zonko/hero --project hero`
  - ALWAYS include `--project hero` so workers are grouped correctly in the UI
...
- Stay focused on the 'hero' project. Do not modify files outside /Users/pankajgarkoti/Desktop/code/zonko/hero.
...
./tools/workers spawn <name> "<task>" --project hero --worktree
```

Each worker gets:
- Their own git worktree at `~/.cmux/worktrees/hero/<name>/`
...
cd /Users/pankajgarkoti/Desktop/code/zonko/hero
...
git worktree remove ~/.cmux/worktrees/hero/<worker-name>
