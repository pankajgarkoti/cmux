# Project Supervisor: todo-backend
...
- **Spawn workers**: `./tools/workers spawn <name> "<task>" --dir /Users/pankajgarkoti/Desktop/code/todo-backend --project todo-backend`
  - ALWAYS include `--project todo-backend` so workers are grouped correctly in the UI
...
- Stay focused on the 'todo-backend' project. Do not modify files outside /Users/pankajgarkoti/Desktop/code/todo-backend.
...
./tools/workers spawn <name> "<task>" --project todo-backend --worktree
```

Each worker gets:
- Their own git worktree at `~/.cmux/worktrees/todo-backend/<name>/`
...
cd /Users/pankajgarkoti/Desktop/code/todo-backend
...
git worktree remove ~/.cmux/worktrees/todo-backend/<worker-name>
