...
YOUR TASK:
Read .cmux/worker-contexts/perm-qa-role.md for your permanent role. You are a permanent worker — you persist across tasks and receive work via [TASK] messages. Read docs/WORKER_ROLE.md for guidelines.
